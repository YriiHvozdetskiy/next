...
const HomePage = () => {
   ...
   return (
      <>
         ...
         <section className={'max-xl:bg-gray-300 max-w-[1430px] w-full px-[15px] gradient'}>
            ...
            <div className={'container flex mt-[10px] lg:mt-0 lg:flex-col text-gray-600'}>
               <a
                  className={'text-secondary w-[50%] font-bold hover:text-primary hover:underline decoration-[6px] underline-offset-4 transition'}
                  href="#"
               >
                  link
               </a>
