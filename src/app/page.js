         ...
         <main className="flex flex-col items-center justify-between py-24">
            ...
            <section className={'bg-gray-300 max-w-[1430px] w-full px-[15px] gradient'}>
               ...
               <ul className={'space-y-2 my-2 lg:space-x-2 lg:space-y-0 flex flex-col lg:flex-row'}>
                  ...
                  <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem fugit illum inventore nulla
                     possimus
                     quo quod sunt ullam, veniam? Architecto fuga inventore mollitia nobis omnis qui quibusdam ratione
                     soluta voluptas.8
                  </li>
                  <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores, doloribus ea modi nam optio
                     quas
                     quibusdam. Autem, eius quod? Consectetur dicta dolorem, earum eos esse facere odio sit ut
                     voluptates.8
                  </li>
                  <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur, cum dignissimos dolorem
                     dolores
               ...
               <div className="[&>*:not(p)]:font-bold [&>*:not(p)]:mt-10">
                  ...
                  <p>
                     Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugiat quis itaque officiis. Repellat
                     nemo
                  ...
                  <p>
                     ...
                     cum enim molestias? Aspernatur fugiat facilis pariatur vitae repellat, veritatis culpa cupiditate
                     qui
               ...
               <p className={'text-mobile sm:text-desk text-primary'}>Lorem ipsum dolor sit amet, consectetur
                  adipisicing
                  elit. Natus, neque.</p>
